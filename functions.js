...
function channelHasVideo(videoTitle, channel) {
  ...
  // if ( channel.videos.find( (x) => x.title === videoTitle))
  //   return true;
  // else
  // return false;
}
...
function searchChannels(query, channels) {
  // Your code here
  return channels.filter( (channel) => {return channel.name.toLowerCase().includes(query.toLowerCase()) || channel.description.toLowerCase().includes(query.toLowerCase()) });
}
